...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',options=[{'label': 'All Sites', 'value':'ALL'},{'label':'CCAFS LC-40','value':'CCAFS LC-40'}, {'label': 'VAFB SLC-4E', 'value': 'VAFB SLC-4E'}, {'label':'KSC LC-39A', 'value':'KSC LC-39A'},{'label':'CCAFS SLC-40','value':'CCAFS SLC-40'}], value='ALL', placeholder='Select launch site', searchable=True),
                                html.Br(),
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        title=f'Total Success Rate for {entered_site}')
...
def get_payload_scatter_chart(entered_site, entered_payload):
    spacex_df_filtered = spacex_df[(spacex_df['Payload Mass (kg)']>=entered_payload[0]) & (spacex_df['Payload Mass (kg)']<=entered_payload[1])]
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df_filtered[spacex_df_filtered['Launch Site']==entered_site]
